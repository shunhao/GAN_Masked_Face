...
def train_old(num_epoch, batch_size, learning_rate, l1_weight):

    train_data = FacadeDataset_204(flag='train', data_range=(0, 3))
    train_loader = DataLoader(train_data, batch_size=batch_size)
    val_data = FacadeDataset_256(flag='train', data_range=(0, 1))
    ...
    for epoch in range(start_epoch, num_epoch):
        ...
        #visual_result(visual_data[0], visual_data[1], GAN.G_model, Unet.model, GAN.trained_epoch+1)
